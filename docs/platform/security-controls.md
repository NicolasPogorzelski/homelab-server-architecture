...
| A.5.36 Compliance with policies | Enforced | [`validate-repo.sh`](../../scripts/validate-repo.sh), 26 checks, run by a pre-commit hook locally and by CI on every push and pull request. |
