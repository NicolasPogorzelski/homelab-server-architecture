...
OS context: Proxmox host + Debian 12 LXCs. Daily driver is admin workstation (Arch-based).
...
| 2026-03-25 | LXC230 OpenWebUI fully onboarded: `tag:ai-stack`, Tailscale Serve HTTPS, PostgreSQL on CT260, Ollama backends (VM100 + admin workstation), E2E verified |
